describe "month", ->
	...
	describe "on calling with zero", ->
		beforeEach -> result = month gameObject, 0
		it "returns the key of the month", -> expect(result).toEqual "e5aab108-4cf0-46d2-9b20-385c3fe64165"
		check()
	describe "on calling between integers", ->
		beforeEach -> result = month gameObject, 1105048
		it "returns the key of the month", -> expect(result).toEqual "b75dc30d-c6b6-465e-b1f4-a3b40c3e5359"
		check()
	describe "on calling close to a lower bound", ->
		beforeEach -> result = month gameObject, 1095850
		it "returns the key of the month", -> expect(result).toEqual "b75dc30d-c6b6-465e-b1f4-a3b40c3e5359"
		check()
	describe "on calling close to an upper bound", ->
		beforeEach -> result = month gameObject, 1136150
		it "returns the key of the month", -> expect(result).toEqual "b75dc30d-c6b6-465e-b1f4-a3b40c3e5359"
		check()
